     ...
     <aside>
        ...
        <div class="col-6 col-md-5">
            ...
            <tr>
                ...
                <th style="color:#ffffff">Описание</th>
                <th style="color:#ffffff">Цена</th>
                <th style="color:#ffffff">Количество</th>
                <th style="color:#ffffff">Катигория</th>
            ...
            <?php
            $Parts = mysqli_query($connect,"SELECT * FROM `Parts`");
            ...
            foreach ($Parts as $product)
            {
                ...
                <tr>
                    ...
                    <td style="color:#ffffff"><?= $product[4] ?></td>
                    <td style="color:#ffffff"><?= $product[5] ?></td>
                    <td> <a style="color:#ffffff" href="update.php?id=<?= $product[0] ?>">Изменить</a></td>
                    <td> <a style="color:#ffffff" href="vend/delet.php?id=<?= $product[0] ?>">Удалить</a></td>
                </tr>
                <?php
      ...
      <div class="col-6 col-md-4">
            ...
            <form action="vend/creat.php" method="post">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="description" class="form-control" id="floatingPassword" placeholder="Пароль">
                ...
                <div class="form-floating mb-3">
                    <input type="number" name="Quantity" class="form-control" id="floatingPassword" placeholder="Пароль">
                    <label for="floatingPassword">Количество</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="Category" class="form-control" id="floatingPassword" placeholder="Пароль">
