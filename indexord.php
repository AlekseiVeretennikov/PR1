     ...
     <aside>
        ...
        <div class="col-6 col-md-5">
            ...
            <tr>
                ...
                <th style="color:#ffffff">Имя Клиента</th>
                <th style="color:#ffffff">Адрес</th>
            ...
            <?php
            $Parts = mysqli_query($connect,"SELECT * FROM `Orders`");
            ...
            foreach ($Parts as $product)
            {
                ...
                <tr>
                    ...
                    <td> <a style="color:#ffffff" href="updateord.php?id=<?= $product[0] ?>">Изменить</a></td>
                    <td> <a style="color:#ffffff" href="vend/deletord.php?id=<?= $product[0] ?>">Удалить</a></td>
                </tr>
                <?php
      ...
      <div class="col-6 col-md-4">
            ...
            <form action="vend/createord.php" method="post">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="Status" class="form-control" id="floatingPassword" placeholder="Пароль">
                    <label for="floatingPassword">Статус</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="Client_name" class="form-control" id="floatingPassword" placeholder="Пароль">
                    <label for="floatingPassword">Имя Клиента</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="Delivery_address" class="form-control" id="floatingPassword" placeholder="Пароль">
