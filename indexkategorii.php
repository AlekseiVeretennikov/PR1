    ...
    <div class="col-6 col-md-2">
     <aside>
        ...
        <div class="col-6 col-md-5">
            ...
            <?php
            $Parts = mysqli_query($connect,"SELECT * FROM `Categories`");
            ...
            foreach ($Parts as $product)
            {
                ...
                <tr>
                    ...
                    <td> <a style="color:#ffffff" href="updatecat.php?id=<?= $product[0] ?>">Изменить</a></td>
                    <td> <a style="color:#ffffff" href="vend/deletcat.php?id=<?= $product[0] ?>">Удалить</a></td>
                </tr>
                <?php
      ...
      <div class="col-6 col-md-4">
            <h1> Добавить Катигорию</h1>
            <form action="vend/creatcat.php" method="post">
